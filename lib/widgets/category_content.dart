...
class _CategoryContentState extends State<CategoryContent> {
  ...
  Widget _buildPanelBody() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        CloudinaryImagePicker(controller: _imageUrlController, isDarkMode: isDarkMode, label: 'Hình ảnh danh mục'),
        const SizedBox(height: 16),
    ...
    return Row(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: Text(_isEditMode ? 'Cập nhật' : 'Thêm', style: TextStyle(color: Colors.white)),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AdminSlidePanel(
      isOpen: _isPanelOpen,
      panelWidth: 420,
      title: _isEditMode ? 'Chỉnh sửa danh mục' : 'Thêm danh mục mới',
      onClose: _closePanel,
