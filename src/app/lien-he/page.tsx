...
function HeroBanner() {
    return (
        ...
        >
            <div style={{ position: "absolute", top: "10%", right: "12%", width: "220px", height: "220px", borderRadius: "50%", background: "radial-gradient(circle, rgba(139,92,246,0.12) 0%, transparent 70%)", animation: "float 6s ease-in-out infinite", pointerEvents: "none" }} />
            <div style={{ position: "absolute", bottom: "5%", left: "8%", width: "150px", height: "150px", borderRadius: "50%", background: "radial-gradient(circle, rgba(139,92,246,0.08) 0%, transparent 70%)", animation: "float 8s ease-in-out infinite reverse", pointerEvents: "none" }} />
            ...
            <div className="container animate-slide-up" style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "var(--space-4xl) var(--space-lg) var(--space-2xl)" }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "var(--space-sm)", padding: "5px 14px", borderRadius: "var(--radius-full)", background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)", marginBottom: "var(--space-lg)", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.15em", color: "var(--color-accent)", textTransform: "uppercase" }}>
                    <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "var(--color-accent)", animation: "pulse-glow 2s ease infinite" }} />
                    Kết Nối Với Chúng Tôi
                </div>
                <h1 style={{ fontSize: "clamp(1.8rem, 4.5vw, 3rem)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.04em", color: "var(--hero-text)", marginBottom: "var(--space-md)" }}>
                    Liên Hệ <span className="gradient-text" style={{ fontStyle: "italic" }}>StyleZone</span>
                </h1>
                <p style={{ color: "var(--hero-subtitle)", fontSize: "clamp(0.85rem, 1.4vw, 1rem)", maxWidth: "520px", margin: "0 auto", lineHeight: 1.7 }}>
                    Chúng tôi luôn sẵn sàng lắng nghe. Hãy để lại lời nhắn hoặc ghé thăm cửa hàng.
                </p>
                <div style={{ marginTop: "var(--space-lg)", display: "flex", alignItems: "center", justifyContent: "center", gap: "var(--space-sm)", fontSize: "0.78rem", color: "var(--text-muted)" }}>
                    ...
                    <span style={{ color: "var(--text-primary)" }}>Liên Hệ</span>
                </div>
            </div>
        </section>
    );
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <p style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.55)", lineHeight: 1.6, marginBottom: "36px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "28px", flex: 1, position: "relative", zIndex: 1 }}>
                                {CONTACT_INFO.map((info, i) => {
                                    const cardRef = useReveal("left", { delay: i * 0.1 });
                                    return (
                                        <div
                                            key={info.title}
                                            ref={cardRef}
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p style={{ fontSize: "0.68rem", fontWeight: 600, color: "rgba(255,255,255,0.45)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "4px" }}>{info.title}</p>
