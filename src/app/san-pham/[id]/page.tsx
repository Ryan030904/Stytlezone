    ...
    return (
        <Link
            ...
            onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 20px 40px rgba(0,0,0,0.5), 0 0 20px rgba(139,92,246,0.08)";
            }}
            onMouseLeave={(e) => {
        ...
        >
            ...
            <div style={{ padding: "var(--space-lg)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "var(--space-sm)" }}>
                    <span style={{ fontSize: "1rem", fontWeight: 700, color: "var(--color-accent)" }}>{formatPrice(displayPrice)}</span>
                    ...
                    <div style={{ animation: "fadeIn 0.3s ease" }}>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: "0.95rem", fontWeight: 600, marginTop: "4px", color: product.stock > 0 ? "var(--color-success)" : "var(--color-error)" }}>
