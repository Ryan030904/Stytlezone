    ...
    return (
        <section
            style={{
                ...
                overflow: "hidden",
                background:
                    "linear-gradient(160deg, #000000 0%, #0a0a12 30%, #1a1040 60%, #0d0d18 100%)",
            }}
        >
            {/* Floating orbs */}
            <div
            ...
            >
                ...
                >
                    Phong cách lịch lãm, hiện đại — khẳng định cá tính riêng của bạn.
                </p>
                ...
                >
                    ...
                    <span style={{ color: "var(--text-primary)" }}>Nam</span>
                </div>
