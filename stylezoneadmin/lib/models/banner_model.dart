...
class BannerModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'updatedBy': updatedBy,
      'isDeleted': isDeleted,
      'isActive': status == BannerStatus.active,
      'targetRank': 'member',
    };
  }
  ...
  static BannerStatus _parseStatus(dynamic value) {
    final s = (value ?? '').toString().toLowerCase();
    return parseStatusFromString(s);
  }

  static BannerStatus parseStatusFromString(String s) {
    switch (s.toLowerCase()) {
      case 'active': return BannerStatus.active;
      case 'archived': return BannerStatus.archived;
      default: return BannerStatus.draft;
    }
  }
