            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: const [
                    DropdownMenuItem(value: 'all', child: Text('🏷️ Tất cả giới tính')),
                    DropdownMenuItem(value: 'male', child: Text('👔 Nam')),
                    DropdownMenuItem(value: 'female', child: Text('👗 Nữ')),
                  ],
                  onChanged: (value) => setState(() => _selectedGender = value ?? 'all'),
                ),
              ),
            ),
          ],
          ...
          child: Column(
            children: [
              ...
              ...provider.categories
                  ...
                  .where((category) => _selectedGender == 'all' || category.gender == _selectedGender)
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 1, child: _tableHeader('Giới tính', isDarkMode)),
        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: Text(
                category.gender == 'male' ? '👔 Nam' : category.gender == 'female' ? '👗 Nữ' : 'Tất cả',
                ...
                style: TextStyle(
                  ...
                  color: category.gender == 'male'
                      ...
                      : category.gender == 'female'
                          ...
                          : isDarkMode ? Colors.white.withValues(alpha: 0.7) : const Color(0xFF6B7280),
                ),
              ),
            ),
          ),
