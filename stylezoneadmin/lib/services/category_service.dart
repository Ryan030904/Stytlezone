...
class CategoryService with BaseServiceMixin {
  ...
  Future<List<Category>> searchCategories(String query) async {
    try {
      ensureAuth();
      // Tìm kiếm client-side vì Firestore prefix-match không hỗ trợ tiếng Việt
      // Danh mục thường ít nên không ảnh hưởng performance
      final allCategories = await getAllCategories();
      final lowerQuery = query.trim().toLowerCase();
      if (lowerQuery.isEmpty) return allCategories;
