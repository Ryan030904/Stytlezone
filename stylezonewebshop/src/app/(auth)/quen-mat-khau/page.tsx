    ...
    return (
        <AuthLayout>
            ...
            <div style={{ textAlign: "center", marginBottom: "0.8rem" }}>
                <div style={{ width: "48px", height: "48px", borderRadius: "50%", background: "rgba(139,92,246,0.10)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "1.25rem", fontWeight: 700, marginBottom: "4px", color: "#111827", textAlign: "center" }}>Quên Mật Khẩu</h1>
            <p style={{ fontSize: "0.8rem", color: "#6b7280", marginBottom: "1.2rem", textAlign: "center", lineHeight: 1.5 }}>Nhập email đã đăng ký để nhận liên kết đặt lại mật khẩu của bạn.</p>
                ...
                <>
                    {error && (
                        <div style={{
                            ...
                            color: "#dc2626", fontSize: "0.82rem", marginBottom: "0.6rem",
