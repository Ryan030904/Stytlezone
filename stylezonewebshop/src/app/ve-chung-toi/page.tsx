    ...
    return (
        ...
        >
            ...
            <div style={{ position: "absolute", inset: 0 }}>
                <Image src="/images/about/about-hero.png" alt="Về Chúng Tôi" fill style={{ objectFit: "cover" }} priority />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(160deg, rgba(0,0,0,0.82) 0%, rgba(10,10,18,0.7) 40%, rgba(26,16,64,0.75) 70%, rgba(13,13,24,0.85) 100%)" }} />
            </div>
            ...
            <div className="container animate-slide-up" style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "var(--space-4xl) var(--space-lg) var(--space-2xl)" }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: "var(--space-sm)", padding: "6px 18px", borderRadius: "var(--radius-full)", background: "rgba(139,92,246,0.15)", border: "1px solid rgba(139,92,246,0.35)", marginBottom: "var(--space-lg)", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.15em", color: "#c4b5fd", textTransform: "uppercase" }}>
                    <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#a78bfa", animation: "pulse-glow 2s ease infinite" }} />
                    Câu Chuyện Của Chúng Tôi
                </div>
                <h1 style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.04em", color: "#ffffff", marginBottom: "var(--space-md)", textShadow: "0 2px 20px rgba(0,0,0,0.5)" }}>
                    Về <span className="gradient-text" style={{ fontStyle: "italic" }}>StyleZone</span>
                </h1>
                <p style={{ color: "rgba(255,255,255,0.78)", fontSize: "clamp(0.95rem, 1.5vw, 1.1rem)", maxWidth: "580px", margin: "0 auto", lineHeight: 1.8, textShadow: "0 1px 8px rgba(0,0,0,0.4)" }}>
                    Hơn cả thời trang — chúng tôi kiến tạo phong cách sống hiện đại, nơi mỗi thiết kế là một câu chuyện về đam mê và sự tinh tế.
                </p>
            </div>
        </section>
    );
...
function StorySection() {
    ...
    return (
        <section className="section" style={{ overflow: "hidden" }}>
            <div className="container about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-4xl)", alignItems: "center" }}>
                <div ref={leftRef}>
    ...
    return (
        <section style={{ padding: "var(--space-4xl) 0", position: "relative", overflow: "hidden" }}>
            ...
            <div ref={ref} className="container" style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.75)", maxWidth: "480px", margin: "0 auto var(--space-2xl)", lineHeight: 1.7 }}>
